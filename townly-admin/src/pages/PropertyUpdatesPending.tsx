...
const PropertiesPending: React.FC = () => {
  ...
  try {
    await api.post(
      `/api/admin/properties/update-requests/${selectedPropertyId}/reject`, 
      { reason } // This matches your RejectUpdateRequestDto
    );
    fetchPendingProperties();
    setShowRejectModal(false);
    setSelectedPropertyId(null);
  } catch (error: any) {
    console.error('Failed to reject update', error.response?.data || error);
