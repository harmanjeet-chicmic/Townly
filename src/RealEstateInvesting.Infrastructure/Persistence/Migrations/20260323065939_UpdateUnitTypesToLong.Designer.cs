...
namespace RealEstateInvesting.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260323065939_UpdateUnitTypesToLong")]
    partial class UpdateUnitTypesToLong
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RealEstateInvesting.Domain.Entities.AdminUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("RealEstateInvesting.Domain.Entities.Investment", b =>
                {
                    ...
                    b.Property<long>("SharesPurchased")
            ...
            modelBuilder.Entity("RealEstateInvesting.Domain.Entities.Log", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RealEstateInvesting.Domain.Entities.Organization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RealEstateInvesting.Domain.Entities.Property", b =>
                {
                    ...
                    b.Property<decimal>("ApprovedValuation")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("RentalIncomeHistory")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("SellingPercentage")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("SharePerSquareFeet")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("RealEstateInvesting.Domain.Entities.PropertyActivationRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("TrexDeployTxHash")
                        .HasMaxLength(66)
                        .HasColumnType("nvarchar(66)");
                    ...
                    b.ToTable("PropertyActivationRecords", (string)null);
                });

            modelBuilder.Entity("RealEstateInvesting.Domain.Entities.PropertyAnalyticsSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PropertyAnalyticsSnapshots");
                });
            ...
            modelBuilder.Entity("RealEstateInvesting.Domain.Entities.PropertyRegistrationJob", b =>
                {
                    ...
                    b.Property<string>("IpfsUri")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("ipfs_uri");

                    b.Property<string>("Location")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("location");

                    b.Property<decimal?>("MintAmount")
                        .HasColumnType("decimal(18,2)")
                        .HasColumnName("mint_amount");

                    b.Property<long?>("OnChainPropertyId")
                        .HasColumnType("bigint")
                        .HasColumnName("on_chain_property_id");
                    ...
                    b.Property<string>("TrexDeployTxHash")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("trex_deploy_tx_hash");
                    ...
                    b.Property<string>("VaultAddress")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("vault_address");

                    b.HasKey("Id");

                    b.ToTable("PropertyRegistrationJobs", (string)null);
                });
            ...
            modelBuilder.Entity("RealEstateInvesting.Domain.Entities.PropertyUpdateRequest", b =>
                {
                    ...
                    b.ToTable("PropertyUpdateRequests");
                });

            modelBuilder.Entity("RealEstateInvesting.Domain.Entities.TokenPurchase", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("TokenPurchases", (string)null);
                });

            modelBuilder.Entity("RealEstateInvesting.Domain.Entities.TokenRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RealEstateInvesting.Domain.Entities.TokenTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RealEstateInvesting.Domain.Entities.UserDeviceToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RealEstateInvesting.Domain.Entities.UserPortfolioSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RealEstateInvesting.Domain.Entities.UserTokenBalance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("TotalGranted")
                        .HasColumnType("decimal(18,2)");
